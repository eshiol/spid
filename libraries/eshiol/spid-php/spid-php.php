<?php
    ...
    class SPID_PHP extends \SPID\AbtractSPID {
        ...
        function __construct($production=false, $servicename='service') {
			...
			$this->idps['Register.it S.p.A.'] = 'https://spid.register.it';
			$this->idps['TeamSystem s.p.a.'] = 'https://spid.teamsystem.com/idp';
			$this->idps['TI Trust Technologies srl'] = 'https://login.id.tim.it/affwebservices/public/saml2sso';
        ...
        public function insertSPIDButtonCSS() {
            echo "<link type=\"text/css\" rel=\"stylesheet\" href=\"/spid4j/spid-sp-access-button/css/spid-sp-access-button.min.css\" />";
        }

        public function insertSPIDButtonJS() {
            echo "<script type=\"text/javascript\" src=\"/spid4j/spid-sp-access-button/js/jquery.min.js\"></script>";
            echo "<script type=\"text/javascript\" src=\"/spid4j/spid-sp-access-button/js/spid-sp-access-button.min.js\"></script>";
            echo "
                <script>
                ...
                case "S":
                    $button = "
                        ...
                        <a href=\"#\" class=\"italia-it-button italia-it-button-size-s button-spid\" spid-idp-button=\"#spid-idp-button-small-".$method."\" aria-haspopup=\"true\" aria-expanded=\"false\">
                            <span class=\"italia-it-button-icon\"><img src=\"/spid4j/spid-sp-access-button/img/spid-ico-circle-bb.svg\" onerror=\"this.src='/spid4j/spid-sp-access-button/img/spid-ico-circle-bb.png'; this.onerror=null;\" alt=\"\" /></span>
        ...
        public function insertSPIDSmartButton($size) {
            ...
            echo "
                <link rel='stylesheet' href='/spid4j/css/agid-spid-enter.css'>
                <div class='agid-spid-enter-button agid-spid-enter-button-size-".strtolower($size)."'>
                    <button class='agid-spid-enter agid-spid-enter-size-".strtolower($size)."' onclick=\"location.href='".$url."'\">
                        <span class='agid-spid-enter-icon'>
                            <img aria-hidden='true' src='/spid4j/img/spid-ico-circle-bb.svg' alt='Entra con SPID' />
                        </span>
			...
			if($method=='post') {
				...
				$button_li = "
					...
					<li class=\"spid-idp-button-link\" data-idp=\"namirialid\">
						<button class=\"idp-button-idp-logo\" name=\"idp\" value=\"Namirial\" type=\"submit\"><span class=\"spid-sr-only\">Namirial ID</span><img class=\"spid-idp-button-logo\" src=\"/spid4j/spid-sp-access-button/img/spid-idp-namirialid.svg\" onerror=\"this.src='/spid4j/spid-sp-access-button/img/spid-idp-namirialid.png'; this.onerror=null;\" alt=\"Namirial ID\" /></button>
					</li>
					<li class=\"spid-idp-button-link\" data-idp=\"posteid\">
						<button class=\"idp-button-idp-logo\" name=\"idp\" value=\"Poste Italiane SpA\" type=\"submit\"><span class=\"spid-sr-only\">Poste ID</span><img class=\"spid-idp-button-logo\" src=\"/spid4j/spid-sp-access-button/img/spid-idp-posteid.svg\" onerror=\"this.src='/spid4j/spid-sp-access-button/img/spid-idp-posteid.png'; this.onerror=null;\" alt=\"Poste ID\" /></button>
					</li>
					<li class=\"spid-idp-button-link\" data-idp=\"sielteid\">
						<button class=\"idp-button-idp-logo\" name=\"idp\" value=\"Sielte S.p.A.\" type=\"submit\"><span class=\"spid-sr-only\">Sielte ID</span><img class=\"spid-idp-button-logo\" src=\"/spid4j/spid-sp-access-button/img/spid-idp-sielteid.svg\" onerror=\"this.src='/spid4j/spid-sp-access-button/img/spid-idp-sielteid.png'; this.onerror=null;\" alt=\"Sielte ID\" /></button>
					</li>
					<li class=\"spid-idp-button-link\" data-idp=\"spiditalia\">
						<button class=\"idp-button-idp-logo\" name=\"idp\" value=\"Register.it S.p.A.\" type=\"submit\"><span class=\"spid-sr-only\">SPIDItalia Register.it</span><img class=\"spid-idp-button-logo\" src=\"/spid4j/spid-sp-access-button/img/spid-idp-spiditalia.svg\" onerror=\"this.src='/spid4j/spid-sp-access-button/img/spid-idp-spiditalia.png'; this.onerror=null;\" alt=\"SpidItalia\" /></button>
					</li>
					<li class=\"spid-idp-button-link\" data-idp=\"timid\">
						<button class=\"idp-button-idp-logo\" name=\"idp\" value=\"TI Trust Technologies srl\" type=\"submit\"><span class=\"spid-sr-only\">Tim ID</span><img class=\"spid-idp-button-logo\" src=\"/spid4j/spid-sp-access-button/img/spid-idp-timid.svg\" onerror=\"this.src='/spid4j/spid-sp-access-button/img/spid-idp-timid.png'; this.onerror=null;\" alt=\"Tim ID\" /></button>
					</li>
					<li class=\"spid-idp-button-link\" data-idp=\"teamsystemid\">
						<button class=\"idp-button-idp-logo\" name=\"idp\" value=\"Team System ID s.p.a\" type=\"submit\"><span class=\"spid-sr-only\">Tim ID</span><img class=\"spid-idp-button-logo\" src=\"/spid4j/spid-sp-access-button/img/spid-idp-teamsystemid.svg\" onerror=\"this.src='/spid4j/spid-sp-access-button/img/spid-idp-teamsystemid.png'; this.onerror=null;\" alt=\"Team System ID\" /></button>
					</li>
				...
				$button_li = "
					...
					<li class=\"spid-idp-button-link\" data-idp=\"namirialid\">
						<a href=\"?idp=Namirial\"><span class=\"spid-sr-only\">Namirial ID</span><img src=\"/spid4j/spid-sp-access-button/img/spid-idp-namirialid.svg\" onerror=\"this.src='/spid4j/spid-sp-access-button/img/spid-idp-namirialid.png'; this.onerror=null;\" alt=\"Namirial ID\" /></a>
					</li>
					<li class=\"spid-idp-button-link\" data-idp=\"posteid\">
						<a href=\"?idp=Poste Italiane SpA\"><span class=\"spid-sr-only\">Poste ID</span><img src=\"/spid4j/spid-sp-access-button/img/spid-idp-posteid.svg\" onerror=\"this.src='/spid4j/spid-sp-access-button/img/spid-idp-posteid.png'; this.onerror=null;\" alt=\"Poste ID\" /></a>
					</li>
					<li class=\"spid-idp-button-link\" data-idp=\"sielteid\">
						<a href=\"?idp=Sielte S.p.A.\"><span class=\"spid-sr-only\">Sielte ID</span><img src=\"/spid4j/spid-sp-access-button/img/spid-idp-sielteid.svg\" onerror=\"this.src='/spid4j/spid-sp-access-button/img/spid-idp-sielteid.png'; this.onerror=null;\" alt=\"Sielte ID\" /></a>
					</li>
					<li class=\"spid-idp-button-link\" data-idp=\"spiditalia\">
						<a href=\"?idp=Register.it S.p.A.\"><span class=\"spid-sr-only\">SPIDItalia Register.it</span><img src=\"/spid4j/spid-sp-access-button/img/spid-idp-spiditalia.svg\" onerror=\"this.src='/spid4j/spid-sp-access-button/img/spid-idp-spiditalia.png'; this.onerror=null;\" alt=\"SpidItalia\" /></a>
					</li>
					<li class=\"spid-idp-button-link\" data-idp=\"timid\">
						<a href=\"?idp=TI Trust Technologies srl\"><span class=\"spid-sr-only\">Tim ID</span><img src=\"/spid4j/spid-sp-access-button/img/spid-idp-timid.svg\" onerror=\"this.src='/spid4j/spid-sp-access-button/img/spid-idp-timid.png'; this.onerror=null;\" alt=\"Tim ID\" /></a>
					</li>
					<li class=\"spid-idp-support-link\">
						<a href=\"https://www.spid.gov.it\">Maggiori informazioni</a>
					</li>
