 ...
 * Joomla.Site.Module.LoginSPID is free software. This version  may have been 
...
if (PluginHelper::isEnabled('authentication', 'spid'))
{
	...
	if (file_exists(JPATH_SPIDPHP . '/spid-php.php'))
	{
		...
		require ModuleHelper::getLayoutPath('mod_login_spid', $layout);
	}
}
