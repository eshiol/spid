...
<form action="<?php echo Route::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="spid-login-form"
	...
	<div class="u-margin-bottom-m">
		<p class="u-text-p"><?php echo Text::_('MOD_LOGIN_SPID_LOGIN_TEXT'); ?></p>
	</div>
	...
	$options = array();
	for ($i = 3; $i > 0; $i--) :
		if ($params->get('spidlevel' . $i, $sParams->get('spidlevel' . $i, 1))) :
			$defaultSpidLevel = $i;
	...
	<div class="posttext">
		<p><img class="spid-agid u-layoutCenter" src="/media/mod_login_spid/images/spid-agid-logo-lb.png" alt=""></p>
	</div>
