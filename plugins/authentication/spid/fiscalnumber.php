...
class FiscalNumber
{
	 ...
	 * @var  string
	 */
	private $normalizedFiscalNumber;
	 ...
	 * Constructor
	 *
	 * @param  string  $fiscalNumber  The fiscalNumber
	 */
	function __construct($fiscalNumber)
	{
		...
		$fiscalNumber = strtoupper($fiscalNumber);
		$this->fiscalNumber = $fiscalNumber;

		$this->normalizedFiscalNumber = '';
		for ($i = 0; $i <= strlen($fiscalNumber); $i++)
		{
			$x = substr($fiscalNumber, $i, 1);
			if (!in_array($i, $normalizeP))
			{
				$this->normalizedFiscalNumber .= $x;
			}
			elseif (isset($normalize[$x]))
			{
				$x = $normalize[$x];
			}
			else
	...
	/**
	 * @return  string	The fiscal number
	 *
	 * @since   3.8.5
	 */
	...
	public function getBirthPlace()
	{
		static $places = array(
			...
			'I600' => "Seminara (RC)",
			'I601' => "Semproniano (GR)",
			'M390' => "Sen Jan Di Fassa/Sen Jan (TN)",
			'I602' => "Senago (MI)",
		...
		$code = substr($this->normalizedFiscalNumber, 11, 4);
